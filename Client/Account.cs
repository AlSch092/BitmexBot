...
namespace BitMexBot
{
    public class Account
    {
        ...
        public UInt64 grossLastValue { get; set; }
        ...
        public static string WalletBalanceURL = "/sapi/v1/capital/config/getall";// + //symbol; //field returned Available Balance
        ...
        public bool GetAccountDetails()
        {
            ...
            this.realisedPnl = data.realisedPnl;
            this.walletBalance = data.walletBalance;
            this.excessMargin = data.excessMargin;
